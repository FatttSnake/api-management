...
enum class ResponseCode(val code: Int) {
    ...
    API_PLATFORM_KEY_CREATE_SUCCESS(BusinessCode.API_PLATFORM, 0),
    API_PLATFORM_KEY_REGENERATE_SUCCESS(BusinessCode.API_PLATFORM, 1),
    API_PLATFORM_KEY_TOPUP_SUCCESS(BusinessCode.API_PLATFORM, 2),

    API_PLATFORM_KEY_INVALID(BusinessCode.API_PLATFORM, 50),
    API_PLATFORM_KEY_SECRET_MISMATCH(BusinessCode.API_PLATFORM, 51),
    API_PLATFORM_KEY_DISABLED(BusinessCode.API_PLATFORM, 52),
    API_PLATFORM_KEY_EXPIRED(BusinessCode.API_PLATFORM, 53),
    API_PLATFORM_KEY_IP_NOT_ALLOWED(BusinessCode.API_PLATFORM, 54),
    API_PLATFORM_KEY_PERMISSION_DENIED(BusinessCode.API_PLATFORM, 55),
    API_PLATFORM_KEY_REQUIRED(BusinessCode.API_PLATFORM, 56),
    API_PLATFORM_DISABLED(BusinessCode.API_PLATFORM, 57),
    API_PLATFORM_QUOTA_EXCEEDED(BusinessCode.API_PLATFORM, 58),
